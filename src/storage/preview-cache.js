 ...
 */
export function inspectCachePath(root, target, expectedType) {
...
export function ensureCacheDir(previewRoot, projectId, assetId) {
  ...
  return ensureCacheDirectory(previewRoot, dir);
}

/** Source-neutral cache directory creation; target must be generated by the caller. */
export function ensureCacheDirectory(previewRoot, dir) {
